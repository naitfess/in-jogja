...
<body class="bg-base-100 overflow-x-hidden min-h-screen">
  ...
  <div class="hero min-h-screen relative">
    ...
    <svg class="absolute top-0 left-[-25%] w-[1100px] h-[1000px] opacity-50 z-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 551 905">
    ...
    <div class="container mx-auto lg:py-20 md:py-16 sm:py-12 py-10 relative z-10">
      <div class="card bg-white shadow-2xl p-8 rounded-lg lg:w-3/5 mx-auto">
        <h2 class="text-3xl font-extrabold text-center mb-8 text-gray-800">Finish Your Transactions</h2>
        ...
        <div class="card-body lg:w-full p-4 md:p-6">  
          ...
          <table class="table-auto w-1/2 text-left">
            <tbody>
                <tr>
                    <th class="py-1 text-sm font-semibold">Name</th>
                    <td class="py-1 text-sm">:</td>
                    <td class="py-1 text-sm">Alung</td>
                </tr>
                <tr>
                    <th class="py-1  text-sm font-semibold">Email</th>
                    <td class="py-1 text-sm">:</td>
                    <td class="py-1  text-sm">alung@gmail.com</td>
                </tr>
                <tr>
                    <th class="py-1  text-sm font-semibold">Total</th>
                    <td class="py-1 text-sm">:</td>
                    <td class="py-1  text-sm">$2000</td>
                </tr>
                <tr>
          ...
          <p>Please send to the VA number and send the proof of the payment</p>
          <form class="w-full" action="{{ route('orders.update') }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <label class="form-control w-full max-w-xs">
                <div class="label pl-0">
                    <span class="label-text">Pick a payment proof file</span>
                </div>
                <input type="file" name="payment" class="file-input file-input-bordered w-full max-w-xs" />
            </label>               
