...
<body class="bg-base-100 overflow-x-hidden min-h-screen">
  ...
  <div class="hero min-h-screen relative">
    ...
    <div class="container mx-auto lg:py-20 lg:w-[1000px] md:py-20 md:w-9/12 sm:py-16 py-12">  
        <div class="text-center mb-8">
            <h1 class="text-3xl md:text-4xl lg:text-5xl font-semibold mt-2">Toyota HiAce</h1>
          </div>
        <div class="card bg-base-100 shadow-xl">  
          <div class="carousel rounded-box w-full">
            <div class="carousel-item w-full">
              <img
                src="{{ asset('images/transportations/hiace2.jpg') }}"
                class="w-full objet-cover" />
            </div>
            <div class="carousel-item w-full">
              <img
                src="{{ asset('images/transportations/ToyotaHiaceInt1.jpg') }}"
                class="w-full" />
            </div>
            <div class="carousel-item w-full">
              <img
                src="{{ asset('images/transportations/ToyotaHiaceInt2.jpg') }}"
                class="w-full" />
            </div>
            <div class="carousel-item w-full">
              <img
                src="{{ asset('images/transportations/ToyotaHiaceInt3.jpg') }}"
                class="w-full" />
            </div>
          </div>
        </div>  
