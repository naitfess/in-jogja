  ...
  <div class="hero min-h-screen relative">
    ...
    <div class="py-24">
      <div class="text-center mb-8">
        <h2 class="text-orange-500 text-2xl md:text-3xl font-regular">Travel With Your Comfort</h2>
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-semibold mt-2">Transportation That We Served</h1>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-center">
        @foreach ($transportations as $transportation)
          <div class="card bg-base-100 w-80 shadow-xl">
            <figure class="p-5">
              <img
                src="{{ asset('images/transportations/' . $transportation->picture) }}"
                alt="Shoes"
                class="rounded-xl object-cover w-full h-48"
              />
            </figure>
            <div class="card-body pt-0">
              <h2 class="card-title">{{ $transportation->name }}</h2>
              <div class="divider divider-secondary my-0"></div>
              <div class="card-actions">
                <a href="{{ route('transportation_details') }}">
                  <button class="btn bg-orange-400 text-white hover:bg-orange-500">View Details</button>
                </a>
              </div>
            </div>
          </div>
