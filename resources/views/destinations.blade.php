  ...
  <div class="hero min-h-screen relative">
    ...
    <div class="py-24">
      <div class="text-center mb-8">
        <h2 class="text-orange-500 text-2xl md:text-3xl font-regular">Travel Beyond Limits</h2>
        <h1 class="text-3xl md:text-4xl lg:text-5xl font-semibold mt-2">Most Popular Places</h1>
      </div>
      <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 justify-center">
        @foreach ($destinations as $destination)  
            <div class="card bg-base-100 w-80 shadow-xl">
                <figure class="p-5">
                    <img
                        src="{{ asset('images/destinations/' . $destination->picture) }}"
                ...
                <div class="card-body pt-0">
                    ...
                    <div class="card-actions">
                        <a href="{{ route('destination_details') }}">
                            <button class="btn bg-orange-500 text-white hover:bg-orange-600">View Details</button>
                        </a>
                    </div>
                </div>
            </div>
